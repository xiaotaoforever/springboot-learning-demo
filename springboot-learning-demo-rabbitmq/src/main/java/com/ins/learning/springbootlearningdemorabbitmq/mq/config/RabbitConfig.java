...
public class RabbitConfig {
    ...
    public RabbitTemplate rabbitTemplate() {
        ...
        rabbitTemplate.setConfirmCallback((correlationData, ack, cause) -> {
            if (ack) {
                log.info("消息成功发送到Exchange:{},{}", correlationData, correlationData != null ? correlationData.getReturnedMessage() : null);
            } else {
        ...
        containerFactory.setErrorHandler(t -> log.error("=======handleError===="+t));
